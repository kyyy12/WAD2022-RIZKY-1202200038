...
if (isset($_POST['submit'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        header("Location: rizky_home.php");
    } else {
...
<body>
    ...
    <div class="clearfix">
            <div class="row">
                <div class="col-6">
                    <img src="avanza.png" style="width:750px;height:745px;">
                </div> 
                ...
                <br>
                <div class="card-body">
                    <form action="rizky_home.php" method="POST">
                    <div class="mb-3" >
                    ...
                    <br>
                        ...
                        <br><br>
                        <a>Anda belum punya akun?</a><a href="rizky_regist.php">Daftar</a>
                    </div>
                    </from>
                </div>  
            </div>
